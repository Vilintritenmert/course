...
// 5-вимірна сітка попередньо обчислених результатів балістики (час
// польоту, горизонтальна дистанція) з нерівномірним кроком по кожній осі.
// Використовується TableSolver замість аналітичного розв'язку рівняння руху.
